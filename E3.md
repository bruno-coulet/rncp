...
![Documentation Swagger de la route de prédiction `/api/predict/all`](img_E3/swagger_api_predict_all.png){ width=90% }
...
```
#####  Table clients - clés API hachées
![BDD table  clients](img_E3/C9_cles_API_haches.png){ width=90% }
...
##### *Ingestion OCR - UI*
![Ingestion OCR - UI](img_E3/C10_ocr_ui.png){ width=90% }

##### *Ingestion OCR - fichier .png*
![Ingestion OCR - fichier .png](img_E3/aquatest.png){ width=50% }

##### *Ingestion OCR - payload*
![Ingestion OCR - payload](img_E3/C10_ocr_payload.png){ width=90% }
...
![métriques](img_E3/3_graphs.png){ width=90% }

##### *interface MLflow - f1 moyenne*
![métriques](img_E3/mean_f1.png){ width=90% }

##### *Interface utilisateur, table `action_logs`*
![action_logs](img_E3/journaux_acces.png){ width=90% }
...
##### *tests Pytest*
![tests Pytest](img_E3/E3_C12_pytest_1.png){ width=90% }
![tests Pytest](img_E3/E3_C12_pytest_2.png){ width=90% }
...
##### *tests Pytest-cov*
![tests Pytest-cov](img_E3/E3_C18_test_coverage.png){ width=90% }
...
![GitHub actions workflow](img_E3/E3_C12_github.workflows.png){ width=90% }
...
![GitHub actions runs](img_E3/E3_C13_github_actions_run.png){ width=90% }
