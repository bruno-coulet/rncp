...
## Intégrer des modèles et des services d’intelligence artificielle - développement API, tests et MLOps
...
![Swagger de la route Predict de prédiction `/api/predict/all`](img/img_E3/swagger_api_predict_all.png)
...
![BDD - table clients - Clés API hachées en BDD](img/img_E3/C9_cles_API_haches.png)
...
![Ingestion OCR - UI](img/img_E3/C10_ocr_ui.png)

##### *Ingestion OCR - fichier .png*
![Ingestion OCR - fichier .png](img/img_E3/aquatest.png)

##### *Payload confirmant l'extraction et prêt pour l'inférence*
![Ingestion OCR - payload](img/img_E3/C10_ocr_payload.png)
...
<blockquote>À partir des métriques courantes et spécifiques au projet, en intégrant les outils de collecte, d’alerte et de restitution des données du monitorage pour permettre l’amélioration du modèle de façon itérative.</blockquote>
...
![Interface MLflow Métriques](img/img_E3/metriques.png)

##### *Suivi temporel de l'évolution du F1-Score et du Recall sur la classe Non-Potable*
![Suivi temporel des métriques via MLflow](img/img_E3/3_graphs.png)



##### *interface MLflow - f1 moyenne*
![métriques](img/img_E3/mean_f1.png)
...
![Tableau de bord des journaux d'accès](img/img_E3/journaux_acces.png)
...
##### *tests Pytest*
![tests Pytest](img/img_E3/E3_C12_pytest_1.png)
![tests Pytest](img/img_E3/E3_C12_pytest_2.png)
...
##### *tests Pytest-cov*
![tests Pytest-cov](img/img_E3/E3_C18_test_coverage.png)
...
<blockquote>en installant les outils et en
appliquant les configuration souhaitées, dans le respect du cadre imposé par le projet et dans une approche MLOps,
pour automatiser les étapes de validation, de test, de packaging et de déploiement du modèle.</blockquote>
...
![GitHub actions workflow](img/img_E3/E3_C12_github.workflows.png)
...
- crée le rapport de couverture .XML (en annexe : **coverage.xml**)

Ce n'est qu'en cas de succès que le code est jugé livrable.

##### *onglet "Actions/runs" de GitHub*
![GitHub actions runs](img/img_E3/E3_C13_github_actions_run.png)
