...
## Réaliser une application intégrant un service d’intelligence artificielle - conception et de développement
...
![Besoins Métier](img/img_E4/besoins_metier.png)
![Composants](img/img_E4/composants.png)
...
![Audit lighthouse](img/img_E4/E4_C14_accessibilite.png)
...
>Note : Pour plus de détail sur la méthodologie de conception, de l'analyse des User Stories jusqu'au choix de l'architecture et de la priorisation des Sprints, veuillez vous référer à l'annexe : **cadrage_agile_architecture.pdf**
...
![architecture](img/img_E4/archi_drink_safe.png)
...
- Découpage préalable du travail à réaliser en 6 étapes :
    ...
    6. Réalisation du schéma d'architecture et décomposition en backlog

*kanban - Trello*
![kanban](img/img_E4/E4_C16_kanban.png)
...
![Curseurs pour mesures manuelles](img/img_E4/E4_C17_mesures_manuelles.png)
*Frontend Flask - interface agent de terrain formulaire d'ingestion OCR*
![Formulaire d'ingestion OCR](img/img_E4/E4_C17_ocr.png)
*Frontend Flask - interface agent de terrain formulaire d'ingestion OCR*
![Formulaire RGPD](img/img_E4/E4_C17_RGPD.png)
...
*   De plus, le middleware de journalisation **anonymise la clé API** avant de l'écrire en base de données. cela évite d'introduire une vulnérabilité où les logs exposeraient les mots de passe ou les clés en clair.
...
Un système de garde-fous sanitaires basé sur les règles métiers de l'OMS est codé en dur dans l'API.
