...
Le livrable final de [drink_safe](https://github.com/bruno-coulet/waterflow/) est conçu pour être déployé sur n'importe quel serveur d'exploitation (VPS ou Cloud) de manière prédictible.
