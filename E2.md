...
Afin de sélectionner la solution la plus adaptée à notre architecture FastAPI et à nos contraintes de production (MVP), j'ai évalué ces solutions selon 6 critères pondérés : l'architecture technique, les performances brutes, le coût financier, la facilité d'intégration logicielle, le respect du RGPD, et l'impact écologique (Green IT)
.
...
Conformément aux exigences du projet, chaque solution a été évaluée pour justifier son adéquation ou son rejet
 :
...
Analyse technique : C'est la solution technologique la plus aboutie du marché, capable de lire des documents extrêmement dégradés
.
Motif du rejet : Cette solution est largement surdimensionnée (overkill) pour notre MVP
...
. Enfin, l'envoi de rapports d'analyses d'eau vers des serveurs potentiellement soumis au Cloud Act américain pose un risque de souveraineté
.
